...
output_xlsx_path = r'Cross_result.xlsx'
ROW_MAE, ROW_MMRE, ROW_PRED = 15, 16, 17
...
def main():
    ...
    sheet.cell(row=ROW_MAE-1, column=1).value = 'Cross_BERT文本+特征'
